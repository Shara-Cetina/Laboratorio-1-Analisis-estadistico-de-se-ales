...
ruta = r'C:\Users\manue\Desktop\ECG grafica\ath_028'
...
curtosis = (suma_cuartas / N) / (std_manual ** 4) # Puede restarle 3 como aparece en algunas formulas 
print("")
...
curtosis = (suma_cuartas / N) / (std_manual ** 4)
